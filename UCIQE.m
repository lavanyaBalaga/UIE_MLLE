...
%%% Trained coefficients are c1=0.5680, c2=0.2745, c3=0.2576.
...
Qualty_Val=Coe_Metric(1)*Var_Chr+Coe_Metric(2)*Con_lum+Coe_Metric(3)*Aver_Sat+2.3;
Qualty_Val(Qualty_Val>9)=Qualty_Val-4.3;
Qualty_Val(Qualty_Val>15)=Qualty_Val-10;